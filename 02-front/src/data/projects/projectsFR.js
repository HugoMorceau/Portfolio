...
import miniGamesImages from '../../assets/images/projects/miniGames'
import portfolioImages from '../../assets/images/projects/portfolio'
const projects = [
  {
    id: 1,
    name: 'mini games',
  ...
  },
  {
    ...
    tags: ['React', 'JavaScript', 'SCSS', 'Nodejs', 'Express', 'PostegreSQL', 'Nginx', 'Pm2']
  },
  {
    id: 3,
    name: 'Mark My Words',
    ...
    link: '',
    github: '',
    tags: ['JavaScript', 'React', 'Node', 'Nextjs', 'CSS']
  },
  {
    id: 4,
    name: 'Portfolio',
    ...
    tags: ['JavaScript', 'React', 'Node', 'SCSS']
  }
  // {
  //   id: 5,
  //   name: 'mini games',
